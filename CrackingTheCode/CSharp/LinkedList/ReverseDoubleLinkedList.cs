...
class Solution {
    ...
    static DoublyLinkedListNode reverse(DoublyLinkedListNode head) {
        ...
        DoublyLinkedListNode validHead = head;

        while (iterator != null) {
            DoublyLinkedListNode newNext = iterator.prev; //hold the new next node

            iterator.prev = iterator.next;      //switch
            iterator.next = newNext;

            validHead = iterator;               //hold last valid head before null
